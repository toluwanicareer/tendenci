...
ALLOWED_HOSTS = ['example.com', 'www.example.com','68.183.142.97', 'isfgs.org','www.isfgs.org']
if DEBUG:
...
set_app_log_filename('/home/developer/log/mysite/app.log')
set_debug_log_filename('/home/developer/log/mysite/debug.log')
